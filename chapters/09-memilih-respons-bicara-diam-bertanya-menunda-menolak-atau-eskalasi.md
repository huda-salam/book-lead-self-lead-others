...
- Seberapa besar dampaknya jika saya salah?
- Seberapa mudah respons ini dibatalkan?
...
Gunakan ketika informasi perlu disampaikan, posisi perlu dijelaskan, atau tindakan perlu dikoordinasikan.

### 2. Diam

Gunakan ketika tidak merespons segera lebih aman atau lebih berguna daripada menambah noise. Diam bukan selalu pasif.

### 3. Bertanya

Gunakan ketika ketidakjelasan merupakan hambatan utama.

### 4. Menunda

Gunakan ketika keputusan atau respons membutuhkan informasi, waktu, atau regulasi emosi tambahan. Menunda harus memiliki alasan dan titik kembali.

### 5. Menolak

Gunakan ketika permintaan bertentangan dengan constraint, kewenangan, prinsip, risiko, atau kapasitas yang tidak dapat diabaikan.

### 6. Mengeskalasi

Gunakan ketika masalah melampaui kewenangan, membutuhkan keputusan pihak lain, atau memiliki risiko yang tidak layak ditangani sendiri.
...
> **“Apa yang berada dalam kewenangan saya, dan apa yang harus diputuskan oleh pihak lain?”**
...
Pertanyaan yang baik memperkecil information gap. Tetapi jangan jatuh ke jebakan klarifikasi tanpa akhir. Jika informasi tambahan tidak akan mengubah keputusan, pertanyaan tambahan mungkin tidak diperlukan.
...
3. titik waktu untuk kembali.

> “Saya ingin memastikan angka ini sebelum memberikan persetujuan. Saya cek dokumennya dan kembali pukul 15.00.”

Yang pertama adalah managed delay. Yang kedua dapat menjadi avoidance.
...
Untuk situasi yang penting, gunakan kartu singkat:

- **Situation:** Apa yang terjadi?
- **Objective:** Apa yang ingin saya capai atau lindungi?
- **Stakes:** Apa konsekuensi jika saya salah?
- **Authority:** Apa yang menjadi kewenangan saya?
- **Information gap:** Apa yang belum saya tahu dan benar-benar dapat mengubah keputusan?
- **Reversibility:** Seberapa mudah respons saya dibatalkan?
- **Options:** Bicara / Diam / Bertanya / Menunda / Menolak / Eskalasi / Bertindak
...
> “Saya sudah tunggu dari kemarin. Kenapa belum selesai?”

Respons refleks:

> “Saya juga punya pekerjaan lain.”

Response Card:

- Situation: pekerjaan belum selesai.
- Objective: menyelesaikan pekerjaan dan menjaga koordinasi.
- Stakes: hubungan terganggu, pekerjaan tertunda.
- Information gap: apakah deadline berubah? Apa hambatan utama?
- Authority: apa yang dapat saya putuskan?
- Reversibility: pesan tertulis dapat meninggalkan jejak.
...
> “Sudah jelas. Kita lanjutkan.”

Atau setelah risiko baru ditemukan:
...
> **Tidak ada satu mode respons yang cocok untuk semua situasi.**
>
> **Pilih respons berdasarkan tujuan, stakes, kewenangan, information gap, dan reversibility.**
>
> **Diam, bertanya, menunda, menolak, dan eskalasi adalah pilihan aktif, bukan sekadar ketiadaan tindakan.**
>
> **Menunda yang baik memiliki alasan dan titik kembali.**
>
> **Eskalasi yang baik membawa fakta, tindakan yang sudah dilakukan, risiko, opsi, dan keputusan yang dibutuhkan.**
>
> **Ketegasan tidak membutuhkan kekasaran.**
>
...
- Gollwitzer & Sheeran (2006), meta-analysis of implementation intentions, for linking intentions with action initiation under specified conditions.
- Brandstätter & Bernecker (2022), work on persistence and timely disengagement, for the distinction between persistence and changing course.
...
- siapa yang memegang informasi;
- apa risikonya jika pesan salah dipahami;
- dan seberapa langsung pesan perlu disampaikan.
...
> “Saya menemukan selisih pada angka ini. Bisa kita cek sumber datanya bersama sebelum final?”
...
### Ekstrem pertama: terlalu takut

> “Kalau beliau sudah bilang begitu, berarti pasti benar.”

Ini mengubah kewenangan menjadi pengganti penalaran.

### Ekstrem kedua: terlalu frontal
...
Ada kecenderungan komunikasi ke atas berubah menjadi pertunjukan:
...
> “Saya perlu data ini untuk menyelesaikan bagian laporan saya. Kalau memungkinkan, bisa kita sepakati kapan datanya tersedia?”

Namun jika ada kewajiban formal, deadline, atau tanggung jawab lintas-unit yang memang sudah ditetapkan, kejelasan tetap diperlukan.

> “Sesuai jadwal yang sudah disepakati, data ini dibutuhkan hari ini. Kalau ada kendala, beri tahu saya sebelum pukul 15.00 supaya kita bisa menyesuaikan.”

Bahasa kolaboratif bukan berarti selalu lunak.
...
> “Setelah melihat data ini, bagian asumsi saya memang perlu diperbaiki.”

Keduanya adalah bentuk leadership yang berbeda dari sekadar “harus selalu mendengarkan bawahan”.

## 8. Jangan membuat semua komunikasi menjadi soal kepribadian
...
> “Target berubah karena kondisi X. Saya tahu perubahan ini tidak nyaman. Berikut yang berubah, berikut yang tetap, dan berikut dukungan yang bisa saya berikan.”

Kejujuran tidak berarti menumpahkan semua ketidakpastian tanpa struktur.
...
- **telepon** untuk isu yang membutuhkan respons cepat;
- **tatap muka** untuk isu sensitif atau percakapan yang membutuhkan dialog;
- **dokumen** untuk keputusan, alasan, dan jejak yang perlu dirujuk kembali.

Ini bukan aturan absolut. Tujuannya adalah mengurangi risiko salah tafsir dan memastikan tingkat dokumentasi sesuai kebutuhan.

## 11. Framework kerja: Audience → Objective → Authority → Risk → Information → Delivery → Confirmation

Framework ini adalah **sintesis kerja buku**, bukan taxonomy komunikasi tervalidasi.

### Audience
Siapa penerimanya dan apa posisinya terhadap Anda?

### Objective
Apa yang sebenarnya ingin dicapai: memberi informasi, meminta keputusan, meminta bantuan, memberi instruksi, mengoreksi, memperingatkan, atau menyelaraskan?

### Authority
Siapa yang berwenang memutuskan atau bertindak?

### Risk
Apa konsekuensi jika pesan salah dipahami atau terlambat?

### Information
Apa yang diketahui, belum diketahui, dan perlu diverifikasi?
...
Sekarang tulis tiga versi.

**Atasan**

> “Ada risiko keterlambatan karena dua sumber belum cocok. Saya sedang verifikasi sumber A dan B. Jika sampai pukul 14.00 belum selesai, saya sarankan kita gunakan opsi C sambil mencatat selisihnya.”

**Rekan**

> “Dua sumber kita belum cocok. Bisa kita cek bagian A dan B bersama? Kalau tidak selesai jam 14.00, kita perlu pilih opsi berikutnya.”
...
::: danger Batas
Adaptasi terhadap audiens tidak boleh berubah menjadi manipulasi: menyembunyikan fakta, mengatakan hal berbeda kepada pihak berbeda demi keuntungan pribadi, atau menggunakan hierarki untuk membungkam informasi yang relevan.
:::
